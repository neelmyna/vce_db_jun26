...
'''
oprs = Db_operations()
person1 = Person('girsh', 'm', 'basar', '2002-01-20') 
person2 = Person('kamalesh', 'M', 'hyderabad', '2004-12-23')
person3 = Person('sahana', 'f', 'warangal', '2004-08-19')
oprs.insert_row(person1)
oprs.insert_row(person2)
oprs.insert_row(person3)
'''